...
namespace myne.Code_Analyzer.Syntax
{
    internal sealed class Parser
    {
        ...
        private Expression_Syntax_Node Parse_Expression(int parent_precedence = 0)
        {
            ...
            if (unary_operator_precedence != 0 && unary_operator_precedence >= parent_precedence)
            {
                ...
                var operand = Parse_Expression(unary_operator_precedence);
        ...
        // private static int Get_Binary_Operator_Precedence(Syntax_Kind_of_Token kind_of_token_object)
        // {
